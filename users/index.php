...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  <div class="container" >
	  <div style ="position:fixed; bottom:150px; right:900px; width: 300px; "  >
		  <div class="row">
			  	<div class="col-lg-13">
					  		<div class="com">
							  <h1> <br></h1>
							...
							<h1> <l1><h5><h1>User Login  
								</h1></h5> </l1></h1><br><br> <br> <br> <br> </div>

	</div>
</div>
</div>
<style>.com{text-align: center; color: #000; background-color: #ffff; border-color: #000000;} </style>
	
	  	<div class="container">
		  <div style ="position:fixed; bottom:100px; right:200px; width: 600px;"  >
         
	  	
		      <form class="form-login" name="login" method="post">
		        <h2 class="form-login-heading">SIGN IN HERE</h2>
		        <p style="padding-left:40%; padding-top:2%;  color:red">
		        	<?php if($errormsg){
echo htmlentities($errormsg);
		        		}?></p>

		        		<p style="padding-left:40%; padding-top:2%;  color:green">
		        	<?php if($msg){
