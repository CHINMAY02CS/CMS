...
$place=$_POST['place'];
$title=$_POST['title'];
$detailsofaccuser=$_POST['detailsofaccuser'];
...
$query=mysqli_query($bd, "insert into tblcomplaints(userId,category,accuser,state,place,title,detailsofaccuser,complaintDetails,complaintFile) values('$uid','$category','$accuser','$state','$place','$title','$detailsofaccuser','$complaintdetials','$compfile')");
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Accuser</label>
<div class="col-sm-4">
<input type="text" name="accuser" required="" value="" required="" class="form-control"> 
</div>
...
<div class="col-sm-4">
<input type="text" name="place" required="no" value="" required="" class="form-control"> 
</div>


<label class="col-sm-2 col-sm-2 control-label">Complaint Title</label>
<div class="col-sm-4">
<input type="text" name="title" required="no" value="" required="" class="form-control"> 
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Details of Accuser</label>
<div class="col-sm-4">
<input type="text" name="detailsofaccuser" required="no" value="" required="" class="form-control"> 
</div>
</div>
