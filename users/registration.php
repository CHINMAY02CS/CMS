	  ...
	  <div style ="position:fixed; bottom:150px; right:900px; width: 300px; "  >
		  <div class="row">
			  	<div class="col-lg-13">
							...
							<h1> <l1><h5><h1>User Registration
								</h1></h5> </l1></h1><br><br> <br> <br> <br> </div>

	</div>
	</div>
	</div><style>.com{text-align: center; color: #000; background-color: #ffff; border-color: #000000;} </style>
	<div style ="position:fixed; bottom:90px; right:200px; width: 600px;"  >
	  	
		      <form class="form-login" method="post">
		        <h2 class="form-login-heading">Register Here</h2>
