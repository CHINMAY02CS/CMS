...
<?php $st='closed';
$query=mysqli_query($bd, "select tblcomplaints.*,users.fullName as name,category.categoryName as catname from tblcomplaints join users on users.id=tblcomplaints.userId join category on category.categoryName=tblcomplaints.category where tblcomplaints.complaintNumber='".$_GET['cid']."'");
...
<tr>
											<td><b>Accuser </b></td>
											<td><?php echo htmlentities($row['accuser']);?></td>
										...
										<td><b>Details of Accuser </b></td>
											<td><?php echo htmlentities($row['detailsofaccuser']);?></td>
